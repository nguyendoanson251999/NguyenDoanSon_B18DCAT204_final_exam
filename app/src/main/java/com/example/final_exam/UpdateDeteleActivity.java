...
import com.example.final_exam.dal.SQLiteHelper;
import com.example.final_exam.model.Item;

import java.util.Calendar;

public class UpdateDeteleActivity extends AppCompatActivity implements View.OnClickListener {
    public Spinner sp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_detele);
        initView();
    ...
    public void onClick(View view) {
        ...
        if(view==eDate){
            ...
            DatePickerDialog dialog=new DatePickerDialog(UpdateDeteleActivity.this, new DatePickerDialog.OnDateSetListener() {
                @Override
